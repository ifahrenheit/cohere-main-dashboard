...
// Handle logout (you also have logout.php link; this POST handler remains safe)
 ...
 * This sets $bgClass to 'admin-bg' when the session role is admin,
 * otherwise 'default-bg'. Adjust role string if your DB uses 'Admin' / 'admin' differently.
 */
...
<!-- apply the role-based class to body -->
...
<nav class="navbar navbar-expand-lg px-3 custom-navbar">
  ...
  <div class="collapse navbar-collapse d-flex justify-content-between align-items-center" id="navbarNav">
    ...
    <li class="nav-item">
        <a class="nav-link text-blue-600 font-semibold" href="manage_employee.php">➕ Manage Employee</a>
    </li>
<?php endif; ?>
        ...
        <?php if (isset($_SESSION['original_admin'])): ?>
            <li class="nav-item">
                <a class="nav-link text-green-600 font-semibold" href="switch_back.php">
                    🔁 Return to Admin (<?= htmlspecialchars($_SESSION['original_admin']['user_email'] ?? '', ENT_QUOTES, 'UTF-8') ?>)
                </a>
            </li>
        <?php endif; ?>
        ...
        <?php if (in_array($_SESSION['role'], ['Admin', 'Manager', 'Director', 'SOM Approver']) ||
            ($_SESSION['is_qa'] ?? false)   // ✅ allow QAs here too
            ): ?>
            <li class="nav-item">
        ...
        <?php if (
            ...
            <li class="nav-item">
                <a class="nav-link" href="#" onclick="event.preventDefault(); showIframe('memoSearch')">Tools</a>
            </li>
        <?php endif; ?>
